...
|---------|------|-------------|-----|
| `thormail-adapter-generic-rest` | `EMAIL` | Generic REST API Adapter | [![npm](https://img.shields.io/npm/v/thormail-adapter-generic-rest)](https://www.npmjs.com/package/thormail-adapter-generic-rest) |
